...
def contract_constant(x, c=7.0):
  return x / c

def contract_constant_1(x, c=1.0):
  return x / c

def contract_radius_5(x, c=5.0):
  return contract(x / c)


def contract_radius_2(x, c=2.0):
  return contract(x / c)


def contract_radius_1_2(x, c=0.5):
  return contract(x / c)


def contract_radius_1_4(x, c=0.25):
  return contract(x / c)


def contract_cube_5(x, c=5.0):
  return contract_cube(x / c)


def contract_cube_2(x, c=2.0):
  return contract_cube(x / c)

def contract_cube_1_2(x, c=0.25):
  return contract_cube(x / 0.25)

def contract_cube_1_4(x, c=0.25):
  return contract_cube(x / 0.25)
