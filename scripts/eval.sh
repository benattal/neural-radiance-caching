...
# source ~/.bashrc
# conda activate /scratch/ondemand28/anagh/miniconda3/envs/yobo
# export PATH="/usr/local/cuda/bin:$PATH"
# export LD_LIBRARY_PATH="/usr/local/cuda/lib64/:/usr/local/cuda/targets/x86_64-linux/lib:/scratch/ondemand28/anagh/miniconda3/envs/yobo/lib64:$LD_LIBRARY_PATH"
...
CMD="$CMD --batch_size 128 --render_chunk_size $RENDER_CHUNK_SIZE --vis_start $VIS_START --vis_end $VIS_END"
...
elif [ $RELIGHT -eq 1 ]; then
    CMD="$CMD --take_stage ${STAGE}${SUFFIX}"
fi
